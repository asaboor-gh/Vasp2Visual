#
# Module manifest for module 'Vasp2Visual'
#
...
FunctionsToExport = 'Close-Writers', 'Disable-SelectiveDynamics', 
               ...
               'Get-PartialDOS', 'Get-Plot', 'Get-SkipSelectBands', 'Get-Summary', 
               'Get-TotalDOS', 'Import-Numbers', 'Measure-Distance', 'Merge-ToSlab', 
               'New-Figure', 'New-Presentation', 'Out-Path', 'Read-AsXml', 
